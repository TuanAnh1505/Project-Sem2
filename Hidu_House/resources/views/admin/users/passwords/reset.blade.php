                        ...
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="col-12">
                                    <div class="d-grid my-3">
                                        <button class="btn btn-primary btn-lg" style="background-color: #f2931f; border-color: #f2931f; font-size: 18px; color: white; margin-top: 10px;">{{ __('Reset Password') }}</button>
                                    </div>
                                </div>
                        </form>
                    </div>
