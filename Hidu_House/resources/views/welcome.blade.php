   ...
   @extends('layouts.app') <!-- Định nghĩa layout chung cho categories.blade.php -->
...
<link rel="stylesheet" href="./../css/welcome.css">
    ...
    <div class="container">
        ...
        <div class="thuc_don">
            @foreach($categories as $category)
                <div class="thuc_don_pizza">
                    <a href="{{ route('menu.show', ['CategoryID' => $category->CategoryID]) }}">
            ...
            @foreach($products as $sp)
                <div class="contact-container text-center">
                    <div class="box">
                        ...
                        <button><a class="muahang" href="{{ url('web_1/chitietsp', ['ma' => $sp->ProductID]) }}">Mua Hàng</a></button>
                    </div>
                    <div class="box_white">
        ...
        <div class="combo_sp" style="background-image: url('images/combo_bg.jpg');max-width: 100%;">
        ...
        <!-- {{ asset('images/footer_bg.jpg') }} -->
        <footer style="background-image:url('images/footer_bg.jpg')">
