...
<form class="bg0 p-t-80 p-b-80" method="post">
    @include('admin.alert')
            ...
            <div class="row">
                                ...
                                <tbody>
                                    ...
                                    @foreach($products as $key => $product)
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="column-2" style="color: #f2931f;">{{ $product->name }}</td>
                                            <td class="column-3">{{ number_format($price, 0, '', '.') }}<a>.VND</a></td>
                                            <td class="column-4">
                                            ...
                                            <td class="column-5">{{ number_format($priceEnd, 0, '', '.') }}<a>.VND</a></td>
                                            <td class="p-r-15">
                ...
                <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                    <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                        ...
                        <button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" style="margin-top:10px;">
                           Đặt Hàng
                        </button>
                    </div>
                </div>
