                ...
                <div class="card border border-light-subtle rounded-3 shadow-sm mt-5">
                    <div class="card-body p-3 p-md-4 p-xl-5">
                        <div class="text-center mb-3">
                            <a href="#!">
                                <img src="/template/images/hidu 1.png" alt="Hidu House Logo" width="250">
                            </a>
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="d-grid my-3">
                                <button type="submit" class="btn btn-primary btn-lg" style="background-color: #f2931f; border-color: #f2931f;">{{ __('Send Password Reset Link') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
